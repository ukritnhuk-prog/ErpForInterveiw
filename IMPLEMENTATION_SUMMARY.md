...
- [src/server/Application/Common/Exceptions/ValidationException.cs](src/server/Application/Common/Exceptions/ValidationException.cs)
- [src/server/Application/Common/Interfaces/IApplicationDbContext.cs](src/server/Application/Common/Interfaces/IApplicationDbContext.cs)
- [src/server/Application/Departments/Commands/DepartmentRequest.cs](src/server/Application/Departments/Commands/DepartmentRequest.cs)
- [src/server/Application/Departments/Commands/DepartmentRequestValidator.cs](src/server/Application/Departments/Commands/DepartmentRequestValidator.cs)
- [src/server/Application/Departments/Models/DepartmentResponse.cs](src/server/Application/Departments/Models/DepartmentResponse.cs)
- [src/server/Application/Employees/Commands/EmployeeRequest.cs](src/server/Application/Employees/Commands/EmployeeRequest.cs)
- [src/server/Application/Employees/Commands/EmployeeRequestValidator.cs](src/server/Application/Employees/Commands/EmployeeRequestValidator.cs)
- [src/server/Application/Employees/Models/EmployeeResponse.cs](src/server/Application/Employees/Models/EmployeeResponse.cs)
