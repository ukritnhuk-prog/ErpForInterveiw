...
{
    [HttpGet]
    public async Task<ActionResult<Response<List<DepartmentResponse>>>> Get(
        CancellationToken cancellationToken)
    {
        var result = await sender.Send(new GetDepartmentsQuery(), cancellationToken);

        return Ok(Response<List<DepartmentResponse>>.Success(result));
    }

    [HttpGet("{id:int}")]
    public async Task<ActionResult<Response<DepartmentResponse>>> GetById(
        int id,
        CancellationToken cancellationToken)
    {
    ...
    [HttpPost]
    public async Task<ActionResult<Response<DepartmentResponse>>> Create(
        ...
        CancellationToken cancellationToken)
    {
        ...
        return CreatedAtAction(
            ...
            Response<DepartmentResponse>.Success(result));
    }

    [HttpPut("{id:int}")]
    public async Task<ActionResult<Response<DepartmentResponse>>> Update(
        int id,
        DepartmentRequest request,
        CancellationToken cancellationToken)
    {
