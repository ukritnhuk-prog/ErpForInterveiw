    ...
    <div class="app-shell">
      <aside class="sidebar">
        ...
        <nav aria-label="Main navigation">
          <a routerLink="/dashboard" routerLinkActive="active"><span aria-hidden="true">▦</span> Dashboard</a>
          <a routerLink="/employees" routerLinkActive="active"><span aria-hidden="true">♙</span> Employees</a>
          <a class="sub-nav" routerLink="/employees" [queryParams]="{add: 'true'}">+ Add employee</a>
          <a routerLink="/departments" routerLinkActive="active"><span aria-hidden="true">▤</span> Departments</a>
